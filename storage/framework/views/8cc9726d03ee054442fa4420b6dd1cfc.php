<div class="container-fluid">
    <div class="card mb-0">
        <div class="card-body">
            <h3 class="card-title"><?php echo e(__('Add Appraisal Section')); ?></h3>
            <form method="post" action="<?php echo e(route('getNewAppraisalType')); ?>" id="appraisal_section_form" class="form-horizontal">
                ...
                <div id="sections-container">
                    <div class="section-group mb-4">
                        <div class="form-group">
                            <label for="section_name"><?php echo e(__('Appraisal Section Name')); ?></label>
                            <input type="text" name="section_name[]" class="form-control"
                                   placeholder="<?php echo e(__('Enter Appraisal Section Name')); ?>">
                        </div>
                        ...
                        <div class="form-group d-flex align-items-center">
                            ...
                            <div class="dropdown-container">
                                ...
                                <select id="roles_0" name="roles[0][]" multiple size="4">
                                <option value="hr">HR</option>
                                <option value="tl">TL/Brand Manager</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="indicators-container">
                                <div class="input-group mb-2 indicator-group">
                                    <input type="text" name="indicators[0][]" class="form-control" placeholder="<?php echo e(__('Enter Indicator')); ?>">
        ...
        sectionGroup.innerHTML = `
            ...
            <div class="form-group d-flex align-items-center align-items-baseline">
                ...
                <div class="dropdown-container bootstrap-select ">
                    ...
                    <select id="roles_${sectionIndex}" name="roles[${sectionIndex}][]" multiple size="4" 
        class="form-control selectpicker" data-live-search="false " 
        data-live-search-style="contains" title='<?php echo e(__('Nothing Selected')); ?>'>
            ...
            <div class="form-group">
                ...
                <div class="indicators-container">
                    <div class="input-group mb-2 indicator-group">
                        <input type="text" name="indicators[${sectionIndex}][]" class="form-control" placeholder="<?php echo e(__('Enter Indicator')); ?>">
                        <div class="input-group-append">
                            <button type="button" class="btn btn-danger remove-indicator"><?php echo e(__('Remove')); ?></button>
                        </div>
                    </div>
...
<!-- heelo  --><?php /**PATH D:\server\htdocs\urtasker\resources\views/settings/variables/partials/appraisal_type.blade.php ENDPATH**/ ?>