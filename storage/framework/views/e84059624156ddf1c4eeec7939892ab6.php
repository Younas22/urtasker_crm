...
<nav class="side-navbar side-bar-margin sidebar-background">
        ...
        <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled mb-5">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('project-management')): ?>
                        <li class="has-dropdown <?php echo e((request()->is('project-management*')) ? 'active' : ''); ?>">
                            <?php if(auth()->user()->can('view-project') || auth()->user()->can('view-task') || auth()->user()->can('client') || auth()->user()->can('view-invoice')): ?>
                                <a href="#Project_Management" aria-expanded="false" data-toggle="collapse">
                                    <i class="dripicons-checklist sidebar-i"></i><span>Market Place</span>
                                </a>
                            <?php endif; ?>
                    ...
                    <?php if(auth()->user()->role_users_id ==1): ?>
                    <li class="<?php echo e((request()->is('screen-monitoring*')) ? 'active' : ''); ?>"><a
                                href="<?php echo e(route('screen-monitoring')); ?>"> <i
                                    class="sidebar-i dripicons-camera sidebar-i"></i><span>Screen Monitoring</span></a>
                    </li>
                    <?php endif; ?>
                        ...
                        <ul id="Timesheets" class="collapse list-unstyled ">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-attendance')): ?>
                                <li id="update_attendance"><a
                                            href="<?php echo e(route('update_attendances.index')); ?>"> Track Attendances</a>
                                </li>
                            <?php endif; ?>
    ...
    <div style="font-size:10px; margin-top: 2px; margin-left: 20px;">This is policy for others</div>
                ...
                <?php endif; ?>
                        ...
                        <!-- <li>
                            <a href="<?php echo e(url('/documentation')); ?>"> <i class="dripicons-information sidebar-i"></i><span><?php echo e(__('file.Documentation')); ?></span></a>
                        </li>
                        <li class="<?php echo e((request()->is('addons*')) ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('addons')); ?>"> <i class="dripicons-flag sidebar-i"></i><span><?php echo e(__('Addons')); ?></span>
                            </a>
                        </li> -->
                    <?php endif; ?>
                    <br><br><br>
...
<?php /**PATH D:\server\htdocs\urtasker\resources\views/layout/main_partials/sidebar.blade.php ENDPATH**/ ?>