    ...
    <select name="leave_type" id="leave_type" class="form-control selectpicker"
        ...
        <?php $__currentLoopData = $leave_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leave_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                ...
                $remainingDays = $remainingDaysMap[$leave_type->id] ?? $leave_type->remaining_allocated_day;
            ?>
            <option value="<?php echo e($leave_type->id); ?>" data-day="<?php echo e($remainingDays); ?>">
                <?php echo e($leave_type->leave_type); ?> (<?php echo e($remainingDays); ?> Days)
            </option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </select>
</div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\server\htdocs\urtasker\resources\views/dashboard/employee_dashboard.blade.php ENDPATH**/ ?>