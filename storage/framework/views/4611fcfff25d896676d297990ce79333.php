    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title font-weight-bold" id="createModalLabel"><?php echo e($sectionData[0]['section']['name']); ?></h3>
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('submitEmployeeAppraisal')); ?>" method="post" id="submitForm">
                    ...
                    <input type="hidden" name="section_name" value="<?php echo e($sectionData[0]['section']['name']); ?>">
                    <input type="hidden" name="section_weightage" value="<?php echo e($sectionData[0]['section']['weightage']); ?>">

                        <div class="col-md-6">
                            <label class="font-weight-bold" style="font-size: 20px;" >Evaluated By</label>
                            <p class="text-muted" style="font-size: 18px;"><?php echo e($sectionData[0]['section']['evaluate_by']); ?></p>
                        </div>
                        <div class="col-md-6">
                    ...
                    <?php $__currentLoopData = $sectionData[0]['indicators']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $indicators): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="indicator">
                    <label style="font-size: 18px; font-weight: light;">
                        <?php echo e($indicators['name']); ?> <span class="score-display ml-2 font-weight-bold">0/10</span>
                    </label>

                        <div class="rating" data-score="0" data-indicator="<?php echo e($indicators['name']); ?>">
                                <?php for($i = 1; $i <= 10; $i++): ?>
                                    <i class="fa fa-star" data-value="<?php echo e($i); ?>"></i>
                                <?php endfor; ?>
                            </div>
                            <input type="hidden" name="performance_indicators[<?php echo e($indicators['name']); ?>]" value="0">
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
<?php /**PATH D:\server\htdocs\urtasker\resources\views/performance/appraisal/create-modal.blade.php ENDPATH**/ ?>