...
<section>
    ...
    <div class="container-fluid mb-3">
        ...
        <?php if(session('message.error')): ?>
            <div class="alert alert-danger"><?php echo e(session('message.error')); ?></div>
        <?php elseif(session('message.success')): ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\server\htdocs\urtasker\resources\views/performance/appraisal/index.blade.php ENDPATH**/ ?>