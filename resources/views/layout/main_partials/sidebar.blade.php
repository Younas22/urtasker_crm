...
<nav class="side-navbar side-bar-margin sidebar-background">
        ...
        <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled mb-5">
                ...
                @can('project-management')
                    ...
                    @if(auth()->user()->role_users_id ==1)
                    <li class="{{ (request()->is('screen-monitoring*')) ? 'active' : '' }}"><a
                                href="{{route('screen-monitoring')}}"> <i
                        ...
                        <ul id="Timesheets" class="collapse list-unstyled ">
                            ...
                            @can('edit-attendance')
                                <li id="update_attendance"><a
                                            href="{{route('update_attendances.index')}}"> Track Attendances</a>
                                </li>
                            @endcan
    ...
    <div style="font-size:10px; margin-top: 2px; margin-left: 20px;">This is policy for others</div>
                ...
                @endcan
                        ...
                        <!-- <li>
                            <a href="{{url('/documentation')}}"> <i class="dripicons-information sidebar-i"></i><span>{{__('file.Documentation')}}</span></a>
                        </li>
                        <li class="{{ (request()->is('addons*')) ? 'active' : '' }}">
                            <a href="{{route('addons')}}"> <i class="dripicons-flag sidebar-i"></i><span>{{__('Addons')}}</span>
                            </a>
                        </li> -->
                    @endif
                    <br><br><br>
