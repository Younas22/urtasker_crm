...
<link rel="stylesheet" href="{{ asset('css/ammar-header.css') }}" type="text/css">
    <nav class="navbar">
            ...
            <div class="ammar-navbar-holder">
                ...
                <span class="image-span" id="site_logo_main">
                    @if($general_settings->site_logo)
						<img class="logo-pic" src="{{asset('/images/logo/'.$general_settings->site_logo)}}">
                        &nbsp; &nbsp;
                    @endif
                </span>
                </div>
                ...
                <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                    {{-- <div class="d-flex flex-row">
                            <div class="dropdown mr-1">
                                <button class="btn btn-info dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="fa fa-plus header-i"></i> {{__('Create')}}
                                </button>
                    ...
                    {{-- <li class="nav-item">
                        <a class="dropdown-header-name" style="padding-right: 10px" href="{{url('/optimize')}}" data-toggle="tooltip" title="Clear all cache with refresh"><i class=" dripicons-plus header-i"></i></a>
                    </li> --}}
                    <li class="nav-item">
                        <div class="btn-group">
                    ...
                    <li class="nav-item">
                        <a class="dropdown-header-name" style="padding-right: 10px" href="{{url('/optimize')}}" data-toggle="tooltip" title="Clear all cache with refresh"><i class="fa fa-refresh header-i"></i></a>
                    </li>
                    <li class="nav-item"><a id="btnFullscreen" data-toggle="tooltip"
                                            title="{{__('Full Screen')}}"><i class="dripicons-expand header-i"></i></a></li>
                    <li class="nav-item ">
