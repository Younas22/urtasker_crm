...
<head>
    <meta charset="utf-8">
    <title>AvantcoreTechnologiesCRM - Attendance Device Addon</title>
    <meta name="description" content="Attendance Device Addon for AvantcoreTechnologiesCRM- HR Management System" />
    <meta name="author" content="AvantcoreTechnologies">
    <meta name="copyright" content="AvantcoreTechnologies">
    <!-- Google fonts - Roboto -->
...
<div id="documenter_sidebar">
    ...
    <h1 style="display: inline;margin-top: -10px">AvantcoreTechnologiesCRM - Attendance Device Addon</h1>
...
<div id="documenter_content">
    ...
    <section id="documenter_cover">
        <h1>AvantcoreTechnologiesCRM - Attendance Device Addon
        </h1>
        <div id="documenter_buttons">
        </div>
        <hr>
        <ul>
            <li>by : AvantcoreTechnologies</li>
            <li>Support : <a href="mailto:support@avantcoretech.com">support@avantcoretech.com</a></li>
        </ul>
        <p>AvantcoreTechnologiesCRM - Attendance Device Addon extends our popular HR software AvantcoreTechnologiesCRM to manage the attendance taken by the biometric device in your organization.
        </p>
    </section>
    <section id="requirement">
        ...
        <p>
            To integrate the addon, you need to have existing installation of our HR software AvantcoreTechnologiesCRM.
        </p>
    </section>
    <section id="install">
        <div class="page-header">
        ...
        <p>
        Unzip the folder you downloaded from Codecanyon. Copy the 'resources' folder from it and delete the existing 'resources' folder from your project folder where AvantcoreTechnologiesCRM installed. Then paste the copied one.
        </p>
        <p>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/aJpehJfH3R0" title="AvantcoreTechnologiesCRM - Attendance Device Addon" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </p>
        <p>
        ...
        <p>
            We can help you install on any cpanel based hosting for as little as $15. You can send the money via paypal to tarik_17@yahoo.co.uk. Contact us at support@avantcoretech.com with you hosting details and payment proof and we'll take care of the rest.
        </p>
        <p>
    ...
    <section id="how_to_use">
        ...
        <p>
            8. Set attendance device date format in our software AvantcoreTechnologiesCRM.
            <img alt="" src="public/documentation/attendance_device_addon/assets/images/8.png">
        </p>
        <p>
            9. Import attendance log in our software AvantcoreTechnologiesCRM.
    ...
    <section id="video_tutorial">
        ...
        <p>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/OKSx1rjo88E" title="AvantcoreTechnologiesCRM - Attendance Device Addon" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </section>
    <section id="support">
        <div class="page-header">
            <h3>SUPPORT</h3>
        ...
        <p>Thank you and with best wishes - <a href="http://avantcoretech.com">AvantcoreTechnologies</a></p>
    </section>
</div>
